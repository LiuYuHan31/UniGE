...
from models.unify import UnifyKGModel
...
# parser.add_argument(
#     "--model_e", default="RotE", choices=all_models, help="Knowledge Graph embedding model"
# )
# parser.add_argument(
#     "--model_h", default="RotH", choices=all_models, help="Knowledge Graph embedding model"
# )
parser.add_argument(
...
def train(args):
    model_path = 'RotE' + '_' + 'RotH'
    save_dir = get_savedir(model_path, args.dataset)
